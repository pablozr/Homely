# 03 - Perfil e onboarding sem casa

**What to build:** apos autenticar, permitir que o usuario informe um nome exibido e chegue a uma tela simples para criar uma casa ou entrar por convite quando nao possui membership ativa.
